...
Os tipos recomendados são `ajuste`, `correcao`, `nova-funcionalidade` e `documentacao`.

Exemplos: `ajuste/curva-forward`, `correcao/coleta-ons` e `documentacao/precificacao`.
